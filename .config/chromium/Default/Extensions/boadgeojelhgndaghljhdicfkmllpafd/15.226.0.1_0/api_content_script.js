var b=function(){this.e=!1;this.b=window.location.origin},
e=function(){};
b.prototype.a=function(a){this.e&&console.info("[ContentMessenger] "+a)};
b.prototype.init=function(){this.a("Initializing CV ContentMessenger");chrome.extension.onMessage.addListener(this.g.bind(this));window.addEventListener("message",this.f.bind(this),!1)};
b.prototype.f=function(a){a.source==window&&a.data&&"CastApi"==a.data.target&&(this.a("Getting message from app: "+JSON.stringify(a.data)),this.c("v1_app_request",a.data,this.d.bind(this)))};
b.prototype.d=function(a){this.a("Extension response: "+JSON.stringify(a));window.postMessage(a,this.b)};
b.prototype.g=function(a,c,d){if("string"!=typeof a)throw"Expecting string from extension. But get: "+JSON.stringify(a);a=JSON.parse(a);"background"==a.source&&"content"==a.target&&(this.a("Getting message from extension: "+JSON.stringify(a)),window.postMessage(a.content,this.b),d&&d({}))};
