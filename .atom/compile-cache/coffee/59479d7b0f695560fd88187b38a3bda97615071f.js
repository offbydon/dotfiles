(function() {
  var $$, AnsiFilter, BufferedProcess, CodeContext, HeaderView, ScriptOptionsView, ScriptView, View, grammarMap, stripAnsi, _, _ref,
  ...
  module.exports = ScriptView = (function(_super) {
    ...
    ScriptView.prototype.initialize = function(serializeState, runOptions) {
      ...
      atom.commands.add('atom-workspace', 'script:run', (function(_this) {
        return function() {
          return _this.defaultRun();
        };
      })(this));
      atom.commands.add('atom-workspace', 'script:run-by-line-number', (function(_this) {
        return function() {
          return _this.lineRun();
        };
      })(this));
      atom.commands.add('atom-workspace', 'script:close-view', (function(_this) {
        return function() {
          return _this.close();
        };
      })(this));
      atom.commands.add('atom-workspace', 'script:kill-process', (function(_this) {
        return function() {
          return _this.stop();
        };
      })(this));
      atom.commands.add('atom-workspace', 'script:copy-run-results', (function(_this) {
        return function() {
